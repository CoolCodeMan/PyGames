...
class Mainloop():
    def __init__(self):
        ...
        pygame.display.set_caption("Collecting challenge. Rounds played: "+str(round_counter))
...
#Pelaajan liikkeet/painallukset ja niiden laukaisemat tapahtumafunktiot
    ...
    def silmukka(self):
        ...
        #robotti pelaajan koordinnaatit ja napit
        self.obj_2_pos_x = 30
        self.obj_2_pos_y = 30
        self.up = False
        self.down = False
        ...
        #hirviö pelaajan koordinaatit ja napit
        self.obj1_pos_x = 800
        self.obj1_pos_y = 30
        self.button_w = False
        self.button_s = False
...
#Näytön päivitys.
    def draw_screen(self):
        ...
        self.obj2_collision_counter = self.font_setting.render(f"Player 1 score: {str(self.obj2_collision_points)}",True, (255, 100, 0))
        self.obj1_collision_counter = self.font_setting.render(f"Player 2 score: {str(self.obj1_collision_points)}", True, (255, 100, 0))
